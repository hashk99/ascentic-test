...
<div class="col-md-9">
	<h2 class="ix_student_back_title">Manage Cloth Products</h2>
	 <br/>
	<a href="<?=base_url('products-create?type=cloth');?>">
  ...
  <thead class="thead-dark">
		...
		<?php foreach($products as $product):?>
			...
			<tr>
				...
				<td><?=$product->color_id.' - '.$product->color_name;?></td>
				<td><?=$product->size_id.' - '.$product->size_name;?></td>
